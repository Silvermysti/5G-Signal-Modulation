...
The flat "81%" hides two regimes. Where the signal is clean enough to carry
...
| High-SNR accuracy ~98.3% (VGG) | matched (99.4% on an easier 3-class task) |
| XGBoost baseline | studied only, not built |
| ResNet (their best, 99.8%) | not yet — skip connections still unbuilt |
